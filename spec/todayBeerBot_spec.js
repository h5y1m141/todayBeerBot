(function() {
  ...
  describe('Bot about Parse RSS', function() {
    ...
    return it('should be return true flg after the target feed already is posted', function() {
      var targetFeedURL;
      targetFeedURL = "http://ameblo.jp/sun2diner/entry-11773725674.html";
      return expect(this.bot.checkIfFeedAlreadyPostOrNot(targetFeedURL)).toBe(true);
    });
  });
