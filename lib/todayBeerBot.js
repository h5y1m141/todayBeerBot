(function() {
  ...
  todayBeerBot = (function() {
    ...
    todayBeerBot.prototype.checkIfFeedAlreadyPostOrNot = function(targetFeedURL, callback) {
      ...
      console.log("connect mongo uri is " + this.uri);
    ...
    todayBeerBot.prototype.postBeerInfoToACS = function(placeID, callback) {
      var data;
      data = {
        login: this.loginID,
    ...
    todayBeerBot.prototype._hasCraftBeerKeyword = function(contents) {
      ...
      flg = null;
      dict = ['本日', '開栓', '開栓情報', '樽生', '限定ビール', 'ペールエール', 'IPA', 'エール', '箕面ビール', '箕面', 'COECO', '湘南ビール', '伊勢角屋麦酒'];
      path = require("path");
