  ...
  todayBeerBot = (function() {
    ...
    todayBeerBot.prototype.postBlogEntry = function(item, placeID, callback) {
      ...
      return this.bitly.shorten(base_url, function(err, response) {
        ...
        return that.postBeerInfoToACS(placeID, postData, base_url, function(result) {
    ...
    todayBeerBot.prototype.checkIfFeedAlreadyPostOrNot = function(targetFeedURL, pubDate, callback) {
      var flg, that;
      that = this;
      flg = null;
      return this.ACS.Objects.query({
        ...
        var WITHINTIMEFLG, currentTime;
        if (e.success) {
          if (e.meta.total_pages === 1) {
    ...
    todayBeerBot.prototype.retweet = function(id_str, callback) {
      return this.twit.verifyCredentials(function(err, data) {
        return console.log(data);
      }).retweetStatus(id_str, function(err, data) {
    ...
    todayBeerBot.prototype.postBeerInfoToACS = function(placeID, message, permalink, callback) {
      var acs, that;
      acs = this.ACS;
      that = this;
      return acs.Statuses.query({
        page: 1,
        where: {
          custom_fields: {
            permalink: permalink
        ...
        if (e.meta.total_pages !== 0) {
          return console.log("" + permalink + ": no postBeerInfo");
        } else {
          ...
          currentTime = that.moment();
          return acs.Users.login(data, (function(_this) {
            return function(response) {
              if (response.success) {
                return acs.Statuses.create({
                  place_id: placeID,
